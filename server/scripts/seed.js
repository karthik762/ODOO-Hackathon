...
async function seed() {
  ...
  const assetsRaw = await Asset.insertMany([
    ...
    { name: "iMac 24 M3 Workstation", serialNumber: "IMAC-001",      model: "Apple iMac 24-inch M3",      category: cat["Desktop PC"]._id,        department: dept["IT"]._id,  purchaseDate: ago(365), cost: 185000, status: "Assigned",    assignedTo: u["admin@admin"]._id,  description: "iMac 24-inch for system administration and dev work" },
    ...
    { name: "LG UltraWide 34",        serialNumber: "LG-UW-001",     model: "LG 34WN80C-B",               category: cat["Monitor"]._id,           department: dept["IT"]._id,  purchaseDate: ago(250), cost: 45000,  status: "Assigned",    assignedTo: u["admin@admin"]._id,  description: "34-inch curved ultrawide QHD monitor" },
    ...
    { name: "iPhone 15 Pro",          serialNumber: "MOB-IP-001",    model: "Apple iPhone 15 Pro",        category: cat["Mobile Device"]._id,     department: dept["IT"]._id,  purchaseDate: ago(100), cost: 134900, status: "Assigned",    assignedTo: u["admin@admin"]._id,  description: "Company iPhone for the IT Admin" },
