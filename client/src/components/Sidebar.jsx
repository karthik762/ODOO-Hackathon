      ...
      <div style={{ flexGrow: 1, padding: '20px 12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <Link 
          ...
          style={{
            ...
            fontSize: '14px',
            fontWeight: '600',
            color: isActive('/maintenance') ? 'var(--accent)' : 'var(--text)',
            background: isActive('/maintenance') ? 'var(--accent-bg)' : 'transparent',
            border: isActive('/maintenance') ? '1px solid var(--accent-border)' : '1px solid transparent',
            transition: 'all 0.2s'
          }}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
